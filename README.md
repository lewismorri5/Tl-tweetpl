...
Enjoy Tl-tweetpl for Twitter and let me know what you want to see next!

### Building Tl-tweetpl

Before Tl-tweetpl will work, you will need to generate some API keys, for Twitter. I will not be distributing my keys.
...
4. For the callback URL, you can do anything you like, but to have it work out of the box, use: `http://Tl-tweetplfortwitter.com`
...
There are fields for the Twitter keys, as well as some third party services that Tl-tweetpl utilizes. You do not have to generate keys for the third party services. Those services just will not work.
